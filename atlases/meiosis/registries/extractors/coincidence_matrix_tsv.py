"""Meiosis-atlas staging extractor — coincidence_matrix TSV → staging rows.

Fifth meiosis staging extractor; same generic TSV-parse pattern as the
prior four. Captures columns + rows verbatim; tags with optional scope
/ source metadata. Type coercion + c_coincidence derivation + flag
computation happen in the normalize_coincidence_matrix extractor
downstream.
"""
