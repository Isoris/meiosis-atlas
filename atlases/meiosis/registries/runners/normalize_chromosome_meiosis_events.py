"""Meiosis-atlas normalizer — promotes staging_chromosome_meiosis_events_v0 →
chromosome_meiosis_events_v1.

Twin of `normalize_tract_classifications.py`. Pure file-IO: reads the
workspace layers index to find the source envelope path, copies its JSON
into raw_results/ for provenance, hands the path to the extractor. No
