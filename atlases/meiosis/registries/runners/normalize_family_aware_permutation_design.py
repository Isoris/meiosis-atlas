"""Meiosis-atlas normalizer — promotes staging_family_aware_permutation_design_v0 →
family_aware_permutation_design_v1.

Twin of `normalize_tract_classifications.py`,
`normalize_chromosome_meiosis_events.py`, and
`normalize_local_inv_controls.py`. Pure file-IO: reads the workspace
layers index to find the source envelope path, copies its JSON into
raw_results/ for provenance, hands the path to the extractor. No
server callbacks needed.
