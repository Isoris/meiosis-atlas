"""Meiosis-atlas normalizer — promotes staging_coincidence_matrix_v0 →
coincidence_matrix_v1.

Fifth meiosis-atlas normalize runner; twin of the prior four. Pure
file-IO: reads the workspace layers index to find the source envelope
path, copies its JSON into raw_results/ for provenance, hands the path
to the extractor. No server callbacks needed.
